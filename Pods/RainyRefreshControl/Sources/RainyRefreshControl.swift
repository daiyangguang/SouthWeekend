...
public final class RainyRefreshControl: ONXRefreshControl {
    ...
    fileprivate var backgroundView: SKView!
    var bgColor = UIColor(red: 85.0/255.0, green: 74.0/255.0, blue: 99.0/255.0, alpha: 1)
    fileprivate var scene: RainScene?
    fileprivate var umbrellaView: UmbrellaView!
    fileprivate var thresholdValue: CGFloat = 100.0
    ...
    override public func didBeginRefresh() {
        ...
        self.umbrellaView.setButtonState(.opened, animated: true)
    }
    ...
    override public func willEndRefresh() {
        ...
        self.umbrellaView.setButtonState(.closed, animated: true)
    }
}
