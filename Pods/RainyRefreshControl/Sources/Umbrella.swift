...
final class UmbrellaView:UIView {
    ...
    fileprivate(set) var state = UmbrellaState.closed
    fileprivate var animationValue: CGFloat {
        set {
    ...
    // MARK: - Methods
    func setButtonState(_ state: UmbrellaState, animated: Bool) {
        if self.state == state {
            return
        }
        self.state = state
...
final class UmbrellaLayer:CALayer {
    ...
    fileprivate var APoint:CGPoint!
    fileprivate var aPoint:CGPoint!
    fileprivate var a1Point:CGPoint!
    
    fileprivate var BPoint:CGPoint!
    fileprivate var bPoint:CGPoint!
    fileprivate var b1Point:CGPoint!
    
    fileprivate var CPoint:CGPoint!
    fileprivate var cPoint:CGPoint!
    
    fileprivate var DPoint:CGPoint!
    fileprivate var dPoint:CGPoint!
    fileprivate var d1Point:CGPoint!
    
    fileprivate var EPoint:CGPoint!
    fileprivate var ePoint:CGPoint!
    fileprivate var e1Point:CGPoint!
    
    fileprivate var FPoint:CGPoint!
